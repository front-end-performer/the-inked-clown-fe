...
//   try {
//     const result: any = await UserModel.findOne({ email: body.email }).lean().exec();
...
//         isError: true,
//         data: null,
//         message: "This account is suspended, please contact the support",
//       };
//     // check for password
...
//       data: null,
//       message:
//         "An error occurred trying to process the request, please try again later",
//     };
//   }
// };
...
//   try {
//     const result: any = await UserModel.findOne({ _id: id }).lean().exec();
//     if (!result)
//       return { isError: true, data: null, message: "User does not exist" };
//     // if account is blocked
//     if (result?.isBlocked)
//       return {
//         isError: true,
